...
Została ona spopularyzowana przez Edgara Franka Codda\index{Codd E.F.}. 
...
Zostaną one przedstawione w rozdziale \todo{wstawić jakoś nazwę rodziału} o metodach specyficznych dla systemu zarządzania bazą danych.
...
Należy zwrócić uwagę na \todo{warunek} \texttt{ON DELETE CASCADE}. Sprawia on, że w razie usunięcia węzła \todo{ustalić terminologię} automatycznie zostaną usunięci wszyscy jego potomkowie.
