...
% Największych probleµow należy się spodziewać w 

% Celem tej pracy jest zaprezentowanie metod przechowywania danych w relacyjnych bazach danych. 


\todo{Sprawę dodatkowo komplikuje dążenie do przechowywani danych w 3 postaci normalnej. Niektóre metody nie są nawet w 1 postaci normalnej. }
